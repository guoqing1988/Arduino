...
#ifndef _SPARSENEOMATRIX_H_
#define _SPARSENEOMATRIX_H_
...
class SparseNeoMatrix : public Adafruit_GFX, public Adafruit_NeoPixel {

 public:

  // Constructor for single matrix:
  SparseNeoMatrix(int w, int h, uint8_t pin = 6,
